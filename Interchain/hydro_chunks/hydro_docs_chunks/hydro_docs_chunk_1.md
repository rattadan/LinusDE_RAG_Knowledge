...
================================================================================
Document: Welcome! Source: https://hydro.cosmos.network/docs
================================================================================


# Welcome! --------

This User Guide is the primary resource for Hydro, an auction platform for Protocol-Owned Liquidity (PoL) built for the Cosmos Hub. Hydro is a decentralized platform that enables ATOM stakers to lock their ATOM to gain voting power, and then vote on bids for Protocol-Owned Liquidity (PoL) deployments. Projects submit bids and offer tribute in exchange for liquidity, and users allocate their voting power to the bids they want to support. Hydro’s smart contracts handle the liquidity deployments, and rewards from tribute are distributed back to voters.

---

**LLM Contextual Output:**

Based on the analysis of the given text chunk and its context:

1. **Technical Details, Parameters, or Processes Described**: The technical details mentioned in this section are:
    * Hydro as a decentralized platform built for the Cosmos Hub that enables ATOM stakers to gain voting power.
    * ATOM stakers lock their tokens to gain voting power and vote on bids for Protocol-Owned Liquidity (PoL) deployments.
    * Projects submit bids and offer tribute in exchange for liquidity.
    * Hydro's smart contracts handle the liquidity deployments.
    * Rewards from tribute are distributed back to voters.

2. **Connection to or Building Upon Surrounding Context**: This chunk serves as an introduction to the Hydro User Guide, explaining the purpose and functionality of the platform, which connects to and builds upon the surrounding context, such as:
    * The objectives and key components of the Pilot Rounds.
    * The features of the Hydro platform, including voting mechanism, liquidity deployment, and rewards distribution.
    * The process of participating in the platform as an ATOM staker, bidder, or voter.

3. **Specific Requirements, Conditions, or Constraints Mentioned**: No specific requirements, conditions, or constraints are mentioned in this section, apart from the need for users to lock their ATOM tokens to gain voting power and vote on bids for Protocol-Owned Liquidity deployments.

This section provides a general overview of the Hydro platform, its purpose, and its functionality, which sets the stage for the detailed documentation and guidelines provided in the following sections of the User Guide.
